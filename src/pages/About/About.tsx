import { IonCard, IonCardContent, IonCardHeader, IonCardSubtitle, IonCardTitle, IonContent, IonImg } from "@ionic/react";
...
export default function About() {
    return <IonContent class="About_content">
        ...
        <div style={{ textAlign: 'center', color: '#eee' }}>--END--</div>
    </IonContent>
}